    ...
    <div class="ui stackable grid srv">
        <div class="six wide column">
            <table class="ui striped table info">
                <thead class="dispy">
                <tr>
                    <th class="rank default-color" colspan="2" style="background-color: #475877 !important;">
                ...
                <tr>
                    <td colspan="2">
                        <a class="ui fluid button submit" href="#"
                           title="Voting gateway for this Hytale server">Vote for us</a>
                    </td>
                </tr>
                </tbody>
            </table>
